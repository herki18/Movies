...
Task("Restore")
    .Does(() =>
    {
        DotNetCoreRestore("./src/Movies.sln");
    });
...
// Build using the build configuration specified as an argument.
 Task("Build")
    .Does(() =>
    {
        DotNetCoreBuild("./src/Movies.sln",
...
Task("PublishWeb")
    ...
    {
        DotNetCorePublish(
            "./src/Movies.Api/Movies.Api.csproj",
...
Task("Run")
    ...
    .Does(() =>
    {
        ...
        DotNetCoreExecute(distDirectory.ToString() + "/Movies.Api.dll", "", settings);
    });
